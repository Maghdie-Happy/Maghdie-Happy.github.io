# Maghdie Petersen 
**Full-Stack Software & Application Developer**  
📍12 Rose Street, Lentegeur, Mitchell’s Plain, Cape Town, 7786  | 📞084-982-8781 | ✉️230600204@mycput.ac.za

Career Objective\
Dedicated ICT student and aspirinng Full-Stack developer with expertise in system architecture and advanced Java Implementation. Committed to continous learning and creative problem-solving within the tech industry.

Education\
**National Senior Certificate (Grade 12)** | Spine Road High School | Completed 2022\
**Higher Certificate in ICT** | Cape Peninsula University of Technology | Completed 2023\
**Diploma in ICT: Applications Development** | Cape Peninsula University of Technology | 2024 – 2026 (Final Year)

Technical Skills\
Software Development  
•	**Full-Stack Languages:** Python, Java, HTML, CSS, JavaScript, MySQL, JSON, and Delphi.  
•	**Cybersecurity:** Beginner Level (Understanding fundamental security protocols).  
Hardware & Networking:  
•	**PC Technician:** Skilled in assembling, diagnosing, and fixing PC hardware.  
•	**Networking:** Experience in setting up networks and Communication Network Foundations.   
Creative & Digital Brand Management:   
•	**Design & Marketing:** Logo making, brand advertisement creation, and social media exposure strategies.  

Projects  
•	Java Wind Turbine Management application for Turbines on the ocean.  
•	Web application that was used for advertising and selling vehicles.  
•	Java Modular Management application that can be used for managing any type of business, logistics and/even industry for example Agriculture.  
•	Currently developing my own game idea.  

Experience & Leadership  
•	**Advanced Java:** Expertise in advanced implementation and system architecture.   
•	**Leadership Experience:** Experienced in coordinating various technical projects, which developed my organization and management skills.  
...
**Mock Interview of Maghdie Petersen**  
This is an video to tell you a bit about myself and to showcase my skills in an interview.  
...
**Task:** My objective was to translate my existing professional CV into a structured Markdown format and organize the overall layout of the portfolio. This included ensuring that all media, specifically my mock interview video and external links, were correctly embedded and functional within a code-based environment.

**Action:** Leveraging my background in HTML, CSS and JavaScript, I adapted quickly to Markdown’s syntax. I focused on maintaining a clean and manageable codebase by using essential GFM features like hierarchal headers, bold emphasis for key details, and structured lists. When navigating the initial layout became tricky, I prioritized a simple, modular structure to avoid technical debt. I specifically spent time troubleshooting the syntax for embedding my interview video and linking my CV file to ensure the paths were recognized correctly by the GitHub environment.
